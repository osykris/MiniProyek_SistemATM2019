...
public class MiniProject1 {
    ...
    public static void main(String[] args) {
        ...
        int pin;
        int nominalUang = 0;
        long kodeBankdannorekeningTujuan = 0;
        int bahasa;
        int menu;
        int saldo;
        int pinBaru;
        ...
        if (bahasa == 1) {
            ...
            if (menu == 2) {
                ...
                if (menu == 2) {
                    ...
                    kodeBankdannorekeningTujuan = sc.nextLong();
                ...
                System.out.println("Masukkan pin lama: " + pin);
            ...
            if (menu == 2) {
                ...
                System.out.println("Enter the old pin: " + pin);
                System.out.print("Enter new pin: ");
                pinBaru = sc.nextInt();
                System.out.println("Your pin has been successfully changed");
                System.out.println("Thank you for using BNI ATM services :) Your ATM card can be collected");
            } else if (menu == 3) {
                System.out.println("Number of Withdrawalsan");
                System.out.println("=========================================");
                System.out.println("1. 100000");
                System.out.println("2. 300000");
                System.out.println("3. 500000");
